...
BEGIN_EVENT_TABLE(IllustrationView, ViewEx)
    ...
    EVT_UPDATE_UI(XRCID("paste_census_in"      ),IllustrationView::UponUpdateInapplicable )
    EVT_UPDATE_UI(XRCID("paste_census_out"     ),IllustrationView::UponUpdateInapplicable )
