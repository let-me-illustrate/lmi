...
// $Id: streamable.hpp,v 1.7.2.4 2006-10-18 01:20:16 chicares Exp $
...
inline xml_lmi::Element& operator>>(xml_lmi::Element& x, streamable& z)
{
    z.read(x);
    return x;
}

inline xml_lmi::Element& operator<<(xml_lmi::Element& x, streamable const& z)
{
    z.write(x);
    return x;
}
