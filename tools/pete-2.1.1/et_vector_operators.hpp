#ifndef et_vector_operators_hpp
#define et_vector_operators_hpp
...
template<class T1,class T2>
inline typename MakeReturn<UnaryNode<ApplyUnary<T1>,
  typename CreateLeaf<std::vector<T2> >::Leaf_t> >::Expression_t
apply_unary(const T1&, const std::vector<T2> & l)
{
  typedef UnaryNode<ApplyUnary<T1>,
    typename CreateLeaf<std::vector<T2> >::Leaf_t> Tree_t;
  return MakeReturn<Tree_t>::make(Tree_t(
    CreateLeaf<std::vector<T2> >::make(l)));
}
...
inline typename MakeReturn<BinaryNode<ApplyBinary<T1>,
  typename CreateLeaf<std::vector<T2> >::Leaf_t,
  typename CreateLeaf<std::vector<T3> >::Leaf_t> >::Expression_t
apply_binary(const T1&, const std::vector<T2> & l, const std::vector<T3> & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<std::vector<T2> >::Leaf_t,
    typename CreateLeaf<std::vector<T3> >::Leaf_t> Tree_t;
  return MakeReturn<Tree_t>::make(Tree_t(
    CreateLeaf<std::vector<T2> >::make(l),
    CreateLeaf<std::vector<T3> >::make(r)));
}
...
apply_binary(const T1&, const std::vector<T2> & l, const Expression<T3> & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<std::vector<T2> >::Leaf_t,
  ...
  return MakeReturn<Tree_t>::make(Tree_t(
    CreateLeaf<std::vector<T2> >::make(l),
    CreateLeaf<Expression<T3> >::make(r)));
}
...
inline typename MakeReturn<BinaryNode<ApplyBinary<T1>,
  ...
  typename CreateLeaf<std::vector<T3> >::Leaf_t> >::Expression_t
apply_binary(const T1&, const Expression<T2> & l, const std::vector<T3> & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<Expression<T2> >::Leaf_t,
    typename CreateLeaf<std::vector<T3> >::Leaf_t> Tree_t;
...
apply_binary(const T1&, const std::vector<T2> & l, const T3 & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<std::vector<T2> >::Leaf_t,
...
inline typename MakeReturn<BinaryNode<ApplyBinary<T1>,
  ...
  typename CreateLeaf<std::vector<T3> >::Leaf_t> >::Expression_t
apply_binary(const T1&, const T2 & l, const std::vector<T3> & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<T2 >::Leaf_t,
    typename CreateLeaf<std::vector<T3> >::Leaf_t> Tree_t;
  return MakeReturn<Tree_t>::make(Tree_t(
    CreateLeaf<T2 >::make(l),
    CreateLeaf<std::vector<T3> >::make(r)));
}
...
inline typename MakeReturn<UnaryNode<ApplyUnary<T1>,
  typename CreateLeaf<Expression<T2> >::Leaf_t> >::Expression_t
apply_unary(const T1&, const Expression<T2> & l)
{
  typedef UnaryNode<ApplyUnary<T1>,
    typename CreateLeaf<Expression<T2> >::Leaf_t> Tree_t;
  return MakeReturn<Tree_t>::make(Tree_t(
...
inline typename MakeReturn<BinaryNode<ApplyBinary<T1>,
  typename CreateLeaf<Expression<T2> >::Leaf_t,
  typename CreateLeaf<Expression<T3> >::Leaf_t> >::Expression_t
apply_binary(const T1&, const Expression<T2> & l, const Expression<T3> & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<Expression<T2> >::Leaf_t,
    typename CreateLeaf<Expression<T3> >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<ApplyBinary<T1>,
  typename CreateLeaf<Expression<T2> >::Leaf_t,
  typename CreateLeaf<T3 >::Leaf_t> >::Expression_t
apply_binary(const T1&, const Expression<T2> & l, const T3 & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<Expression<T2> >::Leaf_t,
    typename CreateLeaf<T3 >::Leaf_t> Tree_t;
...
inline typename MakeReturn<BinaryNode<ApplyBinary<T1>,
  typename CreateLeaf<T2 >::Leaf_t,
  typename CreateLeaf<Expression<T3> >::Leaf_t> >::Expression_t
apply_binary(const T1&, const T2 & l, const Expression<T3> & r)
{
  typedef BinaryNode<ApplyBinary<T1>,
    typename CreateLeaf<T2 >::Leaf_t,
    typename CreateLeaf<Expression<T3> >::Leaf_t> Tree_t;
...
inline
std::vector<T1>& assign(std::vector<T1>& lhs,const RHS& rhs)
{
