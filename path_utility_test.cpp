...
void test_oddities()
{
    ...
    BOOST_TEST_UNEQUAL(z0, fs::absolute(z1).string());
    BOOST_TEST_EQUAL  (z0, z2);
    BOOST_TEST_EQUAL  (z0, fs::absolute(z2).string());
#elif defined LMI_MSW
    BOOST_TEST_EQUAL  (z1, fs::absolute(z0).string());
    BOOST_TEST_EQUAL  (z1, fs::absolute(z1).string());
    BOOST_TEST_EQUAL  (z1, z2);
    BOOST_TEST_EQUAL  (z1, fs::absolute(z2).string());
