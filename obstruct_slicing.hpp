...
// $Id: obstruct_slicing.hpp,v 1.1 2005-02-13 22:01:26 chicares Exp $
...
// Is it desirable to "prevent derivation" from a class? Some say that
...
// legacy class that had a virtual dtor merely because of an obsolete
// "make all dtors virtual" guideline, but has no virtual member other
// than its dtor. After such a proof, it could be removed if wanted,
// but the accompanying unit test shows little runtime cost. It is
// vain to think that this safeguard would make virtual function calls
...
//
// The second technique seems terse and effective enough to be useful,
// and is therefore exposed here.
