...
//std::cout << " br " << ' ' << a << ' ' << b << ' ' << c << ' ' << fa << ' ' << fb << ' ' << fc << std::endl;
...
//              q = (fb - fa) / fa; // PARTLY RECTIFIED
            ...
            // inverse quadratic
                ...
                p = 2.0 * m * fb * (fa - fb) / (fc * fc) - (b - a) * fb * (fb - fc) / (fa * fc);
        ...
        fb = f(b);
//std::cout << j << " br " << ' ' << a << ' ' << b << ' ' << c << ' ' << impetus << std::endl;
...
//std::cout << j << " ch " << impetus << ' ' << t << ' ' << x << ' ' << fx << ' ' << a << ' ' << b << ' ' << c << std::endl;
