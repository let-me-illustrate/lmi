...
@REM
@REM Copyright (C) 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018 Gregory W. Chicares.
@REM
...
START "Installing Cygwin" /WAIT setup-x86 ^
  ...
  --root C:/cygwin-lmi --packages ^
   autoconf,automake,bsdtar,dos2unix,doxygen,gdb,git,libtool,make,openssh,patch,rsync,unzip,wget,zip,zsh
cd C:\cygwin-lmi\etc
echo # >> fstab
