...
//
// Copyright (C) 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018 Gregory W. Chicares.
//
...
BEGIN_EVENT_TABLE(mec_view, ViewEx)
    ...
    EVT_UPDATE_UI(XRCID("paste_census_in"      ),mec_view::UponUpdateInapplicable)
    EVT_UPDATE_UI(XRCID("paste_census_out"     ),mec_view::UponUpdateInapplicable)
