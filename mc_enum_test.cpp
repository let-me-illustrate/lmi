...
// $Id: mc_enum_test.cpp,v 1.19 2008-12-27 02:56:48 chicares Exp $
...
template<>
struct mc_enum_type_info<enum_island>
    :public mc_enum_type_info_impl<enum_island, 3, &island_enums, &island_strings>
{
};
