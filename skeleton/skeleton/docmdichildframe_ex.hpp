...
// $Id: docmdichildframe_ex.hpp,v 1.1.1.1 2004-05-15 19:58:34 chicares Exp $
...
// frame has none. 'StatusBarSoughtFromMenuHighlightHandler' is a mode
// flag used to accomplish this. A more straightforward patch to the
// library could be devised.
    ...
    :public wxDocMDIChildFrame
{
  ...
  private:
    ...
    bool StatusBarSoughtFromMenuHighlightHandler;
