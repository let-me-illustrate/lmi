...
// $Id: mc_enum_test_aux_enums.hpp,v 1.1.1.1 2004-05-15 19:59:04 chicares Exp $

#ifndef mc_enum_test_aux_enums_hpp
#define mc_enum_test_aux_enums_hpp

#include "config.hpp"

enum enum_holiday
    {h_Theophany = 20040106
    ,h_Easter    = 20040411
