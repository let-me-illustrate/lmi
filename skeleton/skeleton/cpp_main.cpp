...
// $Id: cpp_main.cpp,v 1.1.1.1 2004-05-15 19:58:27 chicares Exp $
...
int main(int argc, char* argv[])
{
    ...
    return boost_modified::catch_exceptions
        (boost_modified::test::cpp_main_caller(argc, argv)
        ,std::cout
        ,std::cerr
        );
}
...
// Revision History
//  2004-05-06 GWC removed carriage returns and added code to force
//    mpatrol to link.
